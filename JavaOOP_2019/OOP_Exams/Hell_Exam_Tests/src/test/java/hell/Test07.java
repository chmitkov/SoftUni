...
//T06TestHeroInventoryGetTotalHitPointsBonus
public class Test07 {
    ...
    private static final String WRONG_RESULT = "Wrong result from method getTotalHitPointsBonus";

    @Test
    public void test() throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        Item mockedItem = Mockito.mock(Item.class);
        Mockito.when(mockedItem.getHitPointsBonus())
        ...
        Mockito.when(mockedItem2.getHitPointsBonus())
                .thenReturn(MOCKED_ITEM_VALUE);
        Mockito.when(mockedItem.getName())
        ...
        Assert.assertEquals(WRONG_RESULT,
                MOCKED_ITEM_VALUE * 2, inventory.getTotalHitPointsBonus());
