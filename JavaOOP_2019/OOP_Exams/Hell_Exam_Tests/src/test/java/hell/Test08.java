...
//T06TestHeroInventoryGetTotalDamageBonus
public class Test08 {
    ...
    private static final String WRONG_RESULT = "Wrong result from method getTotalDamageBonus";

    @Test
    public void test() throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        Item mockedItem = Mockito.mock(Item.class);
        Mockito.when(mockedItem.getDamageBonus())
        ...
        Mockito.when(mockedItem2.getDamageBonus())
                .thenReturn(MOCKED_ITEM_VALUE);
        Mockito.when(mockedItem.getName())
        ...
        Assert.assertEquals(WRONG_RESULT,
                MOCKED_ITEM_VALUE * 2, inventory.getTotalDamageBonus());
