...
public class MageHero extends BaseHero {
    ...
    private static final Integer WEAPON_BATTLE_POWER_INIT_VALUE = 40;
    private static final Double WEAPON_PRICE_FOR_UPGRADE_INIT_VALUE = 15D;
    private static final Integer OFFHAND_BATTLE_POWER_INIT_VALUE = 25;
    private static final Double OFFHAND_PRICE_FOR_UPGRADE_INIT_VALUE = 20D;
    private static final Integer ARMOR_BATTLE_POWER_INIT_VALUE = 10;
    private static final Double ARMOR_PRICE_FOR_UPGRADE_INIT_VALUE = 25D;
    ...
    private Integer getCurrentLevel() {
        ...
        try {
            return (Integer) fieldLevel.get(superClass);
    ...
    public Integer getTotalBattlePower() {
        return ((super.getWeapon().getBattlePower()
                ...
                + super.getArmor().getBattlePower()) * 3) / 4;
    }


    @Override
    public String getHeroClass() {
        return String.format("%s - Lvl. %d Mage\n" +
                        "* Mace - %d (BP)\n" +
                        "* Shield - %d (BP)\n" +
                        "* Cuirass - %d (BP)\n" +
                        "%s",
